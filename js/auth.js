            ...
            try {
                ...
                if (profileSnap.exists()) { 
                    ...
                    try {
                        ...
                        if (url.searchParams.get('docaAppId')) shouldBootstrapAdmin = true;
                    } catch (e) {}

                    const createdProfile = {
                        nome: user.displayName || 'Usuário',
                        email: user.email,
                        role: shouldBootstrapAdmin ? 'admin' : 'lojista',
                        departamento: shouldBootstrapAdmin ? 'admin' : 'lojista',
                        status: 'ativo',
                        permissoes: ['inicio'],
                        storeId: null,
                        store: null,
                    ...
                    await setDoc(profileRef, createdProfile, { merge: false });
                    state.currentUserProfile = createdProfile;
                    ...
                    showStatusMessage("Perfil criado automaticamente para este ambiente de teste.", "success", "main");
                }
            } catch(e) {
